...
const CreateNew = (props) => {
    ...
    const handleSubmit = (e) => {
        ...
        navigate('/')
        props.setNotification(`new anecdote '${content.value}' has been created`)
        setTimeout(() => {
    ...
    return (
        <div>
            ...
            <Routes>
                ...
                <Route path='/anecdotes/:id' element={<AnecdotePost anecdote={anecdote}/>} />
